...
const Card = () => {
  ...
  return (
    <div className="pt-14 px-8 sm:fixed top-0 h-100 sm:h-auto left-0 bottom-0 right-1/2 flex flex-col justify-center">
      ...
      <div className="space-y-8 sm:space-y-12">
        <div className="space-y-2 sm:space-y-4">
          ...
          <p className="text-xl">I build responsive, performant web and mobile apps</p>
        </div>
        ...
        <div className=" flex gap-8">
          {
            socials.map((social,index)=> (
                <a key={index} target="_blank" href={social.link}>
                  <img className="w-10" src={social.icon}/>
                </a>
            ))
          }
        </div>
