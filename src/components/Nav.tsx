...
const Nav = () => {
  ...
  return (
    <div className=" bg-gradient-to-b from-[#404040] to-[#494949] *:hover:opacity-80 *:transition duration-200 fixed top-0 z-999 left-0 right-0 flex *:tracking-wider justify-around sm:justify-center sm:gap-40 p-4">
